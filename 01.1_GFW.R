...
withr::with_dir("/Users/ingo/Library/CloudStorage/OneDrive-JamesCookUniversity/02_PhD/06_Chapters/DataChapters/Chapter4_Whalesharks_Risks/Shipping/Shipping", {
  rmarkdown::render("making-maps.Rmd")
})

withr::with_dir("/Users/ingo/Library/CloudStorage/OneDrive-JamesCookUniversity/02_PhD/06_Chapters/DataChapters/Chapter4_Whalesharks_Risks/Shipping/Shipping", {
  rmarkdown::render("Identity.Rmd")
})
